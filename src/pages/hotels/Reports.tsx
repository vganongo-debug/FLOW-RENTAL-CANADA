...
const CHANNEL_DATA = [
  { name: 'Direct / Flow App', bookings: 142, revenue: 38_400, fill: '#015FC4' },
  { name: 'Booking.com',       bookings: 118, revenue: 31_220, fill: '#347FCC' },
  { name: 'Expedia',           bookings:  52, revenue: 14_180, fill: '#B30307' },
  { name: 'Walk-in',           bookings:  34, revenue:  9_080, fill: '#7D0205' },
  { name: 'Corporate / UN',    bookings:  28, revenue: 12_950, fill: '#4A5C74' },
]

const NATIONALITIES = [
  { country: 'Québec',                 arrivals: 142, fill: '#015FC4' },
  { country: 'Terre-Neuve-et-Labrador', arrivals:  88, fill: '#347FCC' },
  { country: 'Ontario',                arrivals:  62, fill: '#B30307' },
  { country: 'France',                 arrivals:  41, fill: '#015FC4' },
  { country: 'United States',          arrivals:  38, fill: '#347FCC' },
  { country: 'Nouveau-Brunswick',      arrivals:  31, fill: '#B30307' },
  { country: 'Nouvelle-Écosse',        arrivals:  28, fill: '#015FC4' },
  { country: 'United Kingdom',         arrivals:  19, fill: '#7D0205' },
  { country: 'Alberta',                arrivals:  17, fill: '#4A5C74' },
  { country: 'Colombie-Britannique',   arrivals:  14, fill: '#347FCC' },
]
      ...
      <ReportShell title="Occupancy & ADR · last 30 days" subtitle="Daily occupancy % overlaid with ADR">
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={OCCUPANCY_30D}>
            ...
            <Line yAxisId="left" type="monotone" dataKey="occupancy" name="Occupancy %" stroke="#015FC4" strokeWidth={2.5} dot={false} />
            <Line yAxisId="right" type="monotone" dataKey="adr" name="ADR (USD)" stroke="#B30307" strokeWidth={2} strokeDasharray="4 3" dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </ReportShell>
      ...
      <ReportShell title="Revenue mix · last 30 days" subtitle="Stacked daily revenue by source">
        <ResponsiveContainer width="100%" height={320}>
          <BarChart data={data}>
            ...
            <Tooltip />
            <Legend wrapperStyle={{ fontSize: 11 }} />
            <Bar dataKey="rooms" stackId="r" name="Rooms" fill="#015FC4" radius={[0, 0, 0, 0]} />
            <Bar dataKey="fnb" stackId="r" name="F&B" fill="#347FCC" radius={[0, 0, 0, 0]} />
            <Bar dataKey="addons" stackId="r" name="Add-ons" fill="#B30307" radius={[2, 2, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </ReportShell>
    </>
      ...
      <ReportShell title="Top 10 guest nationalities" subtitle="Arrivals · last 30 days">
        <ResponsiveContainer width="100%" height={360}>
          <BarChart data={NATIONALITIES} layout="vertical" margin={{ left: 20 }}>
            <CartesianGrid stroke="#E6EFF9" horizontal={false} />
            <XAxis type="number" tick={{ fontSize: 11, fill: '#4A5C74' }} />
            <YAxis dataKey="country" type="category" tick={{ fontSize: 11, fill: '#4A5C74' }} width={120} />
            <Tooltip />

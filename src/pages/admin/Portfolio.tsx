...
const channelMix = [
  { name: 'Direct / Flow App', value: 38, fill: '#0B6E6E' },
  { name: 'Booking.com', value: 31, fill: '#0D8888' },
  { name: 'Expedia', value: 14, fill: '#B87333' },
  { name: 'Walk-in', value: 9, fill: '#7A4B20' },
  { name: 'Corporate / UN', value: 8, fill: '#5A7070' },
]

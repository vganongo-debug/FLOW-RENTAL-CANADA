...
const PAYMENT_METHODS = [
  { method: 'Visa / Mastercard', amount: 142_840, share: 38, color: '#015FC4', icon: CreditCard },
  { method: 'Interac',   amount:  88_220, share: 23, color: '#347FCC', icon: Smartphone },
  { method: 'Apple Pay',       amount:  48_180, share: 13, color: '#B30307', icon: Smartphone },
  { method: 'Google Pay',             amount:  32_980, share:  9, color: '#7D0205', icon: Smartphone },
  { method: 'Banque Nordia',          amount:  28_640, share:  8, color: '#4A5C74', icon: CreditCard },
  { method: 'Cash',               amount:  33_240, share:  9, color: '#8497AE', icon: Banknote },
]
